...
public class signup extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query=" insert into reg (fullname, username,password, address, contact_no)"
        + " values (?, ?, ?, ?, ?)";
      try {
...
/*As we are creating a connection on a local computer we will write the url as jdbc:mysql://localhost:3306 */
  PreparedStatement ps = con.prepareStatement(query);
       ...
       String fname=jTextField1.getText();
        ...
        String cnt = jTextField5.getText();
        ...
        if(cnt.equals(""))
        {
            JOptionPane.showMessageDialog(null, "Add A contact_no");
        }
